...
//   header("location: ../php_files/order.php");
// else 
//   header("location: ../php_files");
?>
    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="../photos/food1.jpg" class="d-block w-100" alt="..." />
        </div>
        <div class="carousel-item">
          <img src="../photos/food2.jpg" class="d-block w-100" alt="..." />
        </div>
        <div class="carousel-item">
          <img src="../photos/food3.jpg" class="d-block w-100" alt="..." />
        </div>
      </div>
      <button
